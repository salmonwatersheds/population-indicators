...
```{r, include=FALSE}
nrow(nuseds_final)     # 310538 309727 307217
nrow(all_areas_nuseds) # 310538 309727 307217
```
...
There are three instances where a special fix is done, as indicated below in the corresponding figures.
...
for(r in 1:nrow(nuseds_CU_GFI_ID)){
  ...
  # r <- which(nuseds_CU_GFI_ID$GFE_ID == 817 &
  #            nuseds_CU_GFI_ID$CU_NAME == "BUTE INLET" &
  #            nuseds_CU_GFI_ID$SPECIES_QUALIFIED == "CM")
