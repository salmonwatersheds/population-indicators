...
biological_status_HSPercetn_1300 <- biological_status_HSPercent_df[biological_status_HSPercent_df$region == "Columbia"  &
                                                                   biological_status_HSPercent_df$cuid == 1300  &
                                                                   biological_status_HSPercent_df$dataPointNb >= 20,]
