...
DFO_streams_here[1,c("X_LONGT","Y_LAT")] <- c(-119.889197,51.598602) 
DFO_streams_here[2,c("X_LONGT","Y_LAT")] <- c(-119.177796,52.345236)  
DFO_streams_here[3,c("X_LONGT","Y_LAT")] <- c(-119.701668,51.593091) 
DFO_streams_here[4,c("X_LONGT","Y_LAT")] <- c(-119.810014,51.579465) 
DFO_streams_here[5,c("X_LONGT","Y_LAT")] <- c(-119.173514,52.281312)
...
In case i = `r i`: the focal series `r paste("CO_46795","33103",sep = " - ")` in blue is merged to the alternative series `r paste("CO_46795","281",sep = " - ")` in red. The other focal series `r paste("CO_46795","1921661712",sep = " - ")` in green is added to **CUSS**.
