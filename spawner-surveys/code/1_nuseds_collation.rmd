...
show <- all_areas_nuseds[toRemove_r,cols_NuSEDS]
rownames(show) <- NULL
show
```
...
#' There are inconsistences and I do not want to spend too much time fixing them,
...
TODO: Flag the time series with data point more recent than 2020
...
nrow(trackRecord_nuseds_gfeid) # 35 34
...
if(export_datasets){
  ...
  write.csv(log_file,paste0(wd_output_local,"/1_log_file.csv"),row.names = F)
