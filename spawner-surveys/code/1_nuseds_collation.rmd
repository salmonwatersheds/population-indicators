...
The other focal series `r paste("CO_46170","54282",sep = " - ")` in black ("DAM"; top plot) is instead added to **CUSS**. Its `GFE_ID` is not in **CUSS**: but it is in **DFO streams file** but without coordinates:
